...
import com.stochastictinkr.skywing.uibuilder.ImageConfig
...
internal fun buildImage(init: ImageConfig.() -> Unit, source: Any = init): Image? {
    return ImageBuilder(source).apply(init).image
}

internal fun buildImages(init: ImageConfig.() -> Unit, source: Any = init): List<Image> {
